...
const initialFormDataState: Omit<Post, 'id'> = {
  description: '',
  featuredImage: '',
  publishDate: '',
  published: false,
...
export default function CreatePost() {
  ...
  const [formData, setFormData] = useState<Omit<Post, 'id'>>(initialFormDataState)
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (postId) {
      await updatePost({ ...formData, id: postId }).unwrap()
    } else {
